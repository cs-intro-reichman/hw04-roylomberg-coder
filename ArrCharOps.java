...
public class ArrCharOps {
    ...
    public static void main(String[] args) {
        ...
        // Demo prints (char[] needs println to print contents)
     ...
     *         -2 if there is an error with the input.
     */
    public static int compareTo(String str1, String str2) {
        // Input validation (spec says return -2 on input error)
        ...
        // All shared-prefix characters are equal; shorter string is smaller
